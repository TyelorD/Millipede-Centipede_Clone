 ...
 * ------------------------------------------------------
 * When specifying any of the above in your preferences2.xmll, use custom: instead of android:
 * For example:
 *      android:key="test"
...
public class NumberPickerPreference extends DialogPreference
{
    ...
    // to define custom attributes (custom: instead of android:) in preferences22.xml
